...
const FleetManagementCardReverse = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse justify-between gap-6 md:gap-8 lg:gap-12 xl:gap-18 2xl:gap-20  border-b border-black pb-10 lg:pb-14 xl:pb-20">
      <motion.div
        initial={{ opacity: 0 }}
...
export default FleetManagementCardReverse;
